...
def main(NUM_EPOCHS, BATCH_SIZE, MAX_SEQUENCE_LENGTH, model_name):
    """
    Main function to train and test Bidirectional LSTM model
...
if __name__ == "__main__":
    ...
    model_name = 'Bidirectional_LSTM-max_length' + args.max_length + 'batch_size' + args.batch_size + 'num_epoch' + args.num_epoch
