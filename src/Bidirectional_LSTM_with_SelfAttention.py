...
def main(NUM_EPOCHS, BATCH_SIZE, MAX_SEQUENCE_LENGTH, model_name):
    """
    Main function to train and test Bidirectional LSTM with self-attention model
...
if __name__ == "__main__":
    ...
    model_name = 'Bidirectional_LSTM_with_SelfAttention-max_length' + args.max_length + 'batch_size' + args.batch_size + 'num_epoch' + args.num_epoch
